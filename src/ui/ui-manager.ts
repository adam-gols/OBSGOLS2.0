...
import { GameFormHandler } from './components/game-form-handler';
...
export class UIManager {
  ...
  private gameFormHandler: GameFormHandler | null = null;
  ...
  private async loadTemplate(): Promise<void> {
    try {
      ...
      if (!widgetContainer) {
        console.error('❌ Widget container (#gols-widget) not found in DOM');
        throw new Error('Widget container (#gols-widget) not found in DOM');
      }
      
      console.log('✅ Widget container found, creating template content...');
      
      // Create the template content directly
      const templateContent = this.createTemplateContent();
      
      console.log('🎨 Template content created, injecting into DOM...');
    ...
    return `
      ...
      <header class="gols-header">
        <div class="gols-logo-section">
          <img src="/GOLSLOGO.svg" alt="Game On Live Studio" class="gols-logo-img">
        </div>
  ...
  private async initializeComponents(): Promise<void> {
    ...
    try {
      ...
      this.gameFormHandler = new GameFormHandler(
        this.eventManager,
        this.settingsManager,
        this.logger
      );
  ...
  public destroy(): void {
    try {
      ...
      if (this.gameFormHandler) {
        this.gameFormHandler = null;
      }
